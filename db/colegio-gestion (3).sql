...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2021 a las 21:49:48
...
INSERT INTO `gastos` (`id_gasto`, `id_proveedor`, `ga_fecha`, `ga_descripcion`, `ga_importe`, `ga_rubro`, `ga_usuario`) VALUES
(3, 1, '2021-10-09', 'Rollos de membrana de alto tránsito x 4 mm', 450, 1, 2),
(4, 2, '2021-10-09', 'mi prueba de codigo si funciona', 450, 1, 2),
(5, 0, '2021-10-09', 'Rollos de membrana de alto tránsito x 4 mm', 600, 2, 2),
(6, 3, '2021-10-09', 'esta es mi prueba un poco mas detallada', 700, 1, 2),
(7, 2, '2021-10-09', 'Rollos de membrana de alto tr?nsito x 4 mm', 999, 2, 2),
(8, 3, '2021-10-09', 'Metros de Membrana autoadhesiva', 600, 3, 2);
...
(37, 20, 2, 'DULCE DE ZAPALLO 800 G', 1, 300.00),
(38, 21, 1, 'DULCE DE LECHE 1/2 KG Peña', 1, 250.89),
(39, 22, 39, 'PLANTINES CITRUS', 4, 500.00),
(40, 23, 1, 'DULCE DE LECHE 1/2 KG Peña', 1, 250.89);
...
--
ALTER TABLE `clientes_ctacte`
  MODIFY `id_ctacte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `recibos`
  MODIFY `id_recibo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
