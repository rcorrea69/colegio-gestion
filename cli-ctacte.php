...
$sqlcli = "SELECT `id_cliente`, `pe_apellido`, `pe_nombre`, `pe_telefono`, `Debe`, `Haber`
...
?>
<div class="container">
    <h4 class="mt-2 mb-4"> <?php echo $nombrecli . "    "; ?>
                    ...
                    <div class="collapse" id="collapsePagos">
                        <div class="card border-primary card-body">
                            <form id="frm-pago" name="frm-pago">
                                <div class="form-row">
                                    <input type="hidden" id="cliente" value="<?php echo $idCliente; ?>"/>
