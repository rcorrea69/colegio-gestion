<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'hardware.derecho@gmail.com'; //Modificar
		$mail->Password = 'rcorrealkt369'; //Modificar
		
		$mail->setFrom('hardware.derecho@gmail.com', 'Dpto de Hardware - Derecho'); //Modificar
