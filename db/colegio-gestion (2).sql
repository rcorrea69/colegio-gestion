...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-02-2022 a las 23:46:11
...
(2, 'Banco Cta Cte', 500.00, '2022-01-01');
...
(16, 'mi subrubro', 1, 0.00, '2022-01-01'),
(17, 'prueba', 3, 500.00, '2022-02-03');
...
(26, 1, '2022-02-03', 580.89, 2, 1, NULL, 0);
...
--
ALTER TABLE `cajas`
  MODIFY `id_mov` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
--
ALTER TABLE `gastos`
  MODIFY `id_gasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
